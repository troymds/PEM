...
- (void)viewDidLoad
{
    ...
    // 设置普通背景图片
    [btn setBackgroundImage:[UIImage imageNamed:@"modify.png"] forState:UIControlStateNormal];
    [btn setBackgroundImage:[UIImage imageNamed:@"modify_pre.png"] forState:UIControlStateHighlighted];
    // 设置尺寸
